  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-bold text-earth-900">Sales</h1>
          <p className="text-earth-500 text-sm mt-1">Record customer sales and keep product stock in sync.</p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="card">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-earth-700 mb-1.5">Amount Paid (ETB)</label>
                <input type="number" step="0.01" className="input-field" {...register('amountPaid', { valueAsNumber: true })} />
              </div>
              <button className="btn-primary w-full" type="submit">Create Sale</button>
            </form>
          </div>
          <div className="lg:col-span-2 card overflow-x-auto">
            <h2 className="font-display text-lg font-semibold text-earth-900 mb-4">Sales List</h2>
