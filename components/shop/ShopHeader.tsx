...
export default function ShopHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#fff1e7]/border-b border-[#e0c0b2]/40">
      <div className="mx-auto flex max-w-[1280px] items-center justify-between px-5 py-3 md:px-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="hidden rounded-md border border-[#8c7166]/40 px-3 py-2 text-xs font-bold uppercase tracking-wider text-[#594238] transition hover:border-[#9e3d00] hover:text-[#9e3d00] sm:inline-flex"
          >
            Ops
          </Link>
        </div>
